      ...
      _.each(fields, function(field, i) {
        ...
        _.each(fieldAttr, function(attr, x){
          ...
          if (attr === "foreignKey") {
            ...
            if (self.sequelize.options.dialect === "mysql" && self.tables[table][field].type.includes('BIT')) {
              const [ defaultBinary ] = defaultVal.match(/\d+/);
              val_text = parseInt(defaultBinary, 2);
              defaultVal = val_text;
            }
            // mssql bit fix
